        ...
        <div aria-label="Orange and tan hamster running in a metal wheel" role="img" className={styles.wheel_and_hamster}>
            ...
            <div className={styles.hamster}>
                <div className={styles.hamster__body}>
                    ...
                    <div className={styles.hamster__limb__fr}></div>
                    <div className={styles.hamster__limb__fl}></div>
                    <div className={styles.hamster__limb__br}></div>
                    <div className={styles.hamster__limb__bl}></div>
